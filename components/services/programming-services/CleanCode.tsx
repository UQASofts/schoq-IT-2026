...
export default function CleanCode() {
  ...
  const t = useTranslations("ProgrammingServices.CleanCode");
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 md:gap-16 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
